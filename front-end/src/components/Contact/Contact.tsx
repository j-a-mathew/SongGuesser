    ...
    return (
        <div className={styles.backgroundColor}>
            <div className={styles.verticalCenter}>
                ...
                <br></br>
                <br></br>
                Thanks to Coding Temple, <a href="https://www.bezkoder.com/">BezKoder</a> for assistance with the back-end functionality,
                and to Kiki for her design inspiration assitance!
                <br></br>
                <br></br>
                😊 
                </Typography>
